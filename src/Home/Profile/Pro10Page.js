...
import pro10 from '../BoxLogo/10.jpg'
...
class Pro10Page extends Component {
  render() {
    return (
      <div>
        <Global />
            ...
            <div className="companyInfo infoBox">
              <div className="recruitInfo">
                <div className="company">
                  <span className="companyName">셔츠룸 펀펀</span>
                </div>
                <h1>1~1시간30분 5개이상</h1>
                <div className="companyLogo">
                  <div className="logo">
                    <img src={pro10} alt="Smiley face"/>
                  </div>
                </div>
              </div>
    ...
    <p align="center" style={{ margin: 0 }}>
      <font color="#7f7f7f" size={3}>
        <strong>
          ...
          <font color="#000000"> 케어1등 성민실장 </font>
          <font color="#ff0000">√</font>
        </strong>
      </font>
    </p>
