...
import pro29 from '../BoxLogo/29.jpg'
            ...
            <div className="companyInfo infoBox">
              <div className="recruitInfo">
                <div className="company">
                  <span className="companyName">더 나인</span>
                </div>
                <h1>순수 테이블 알바</h1>
                <div className="companyLogo">
                  <div className="logo">
                    <img src={pro29} alt="Smiley face"/>
                  </div>
                </div>
              </div>
...
>
  ...
  <div style={{ textAlign: "center", lineHeight: "1.8" }} align="center">
    <span style={{ fontSize: "15pt", color: "rgb(0, 0, 0)" }}>
      ...
      <span style={{ color: "rgb(255, 0, 0)" }}>
        <b>
          <span style={{ fontSize: "15pt" }}>010-7523-7669</span>
        </b>
      </span>{" "}
  ...
  <div style={{ textAlign: "center", lineHeight: "1.8" }} align="center">
    ...
    <span style={{ fontSize: "9pt", color: "rgb(0, 0, 0)" }}>
      <span style={{ color: "rgb(255, 0, 0)" }}>
        <b>
          <span style={{ fontSize: "9pt" }}>010-7523-7669</span>
        </b>
      </span>{" "}
