...
import pro44 from '../BoxLogo/44.jpg'
...
class Pro44Page extends Component {
  render() {
    return (
      <div>
        <Global />
            ...
            <div className="companyInfo infoBox">
              <div className="recruitInfo">
                <div className="company">
                  <span className="companyName">강남역 가스통</span>
                </div>
                <h1>즐기면서 가스통과 함께해요~</h1>
                <div className="companyLogo">
                  <div className="logo">
                    <img src={pro44} alt="Smiley face"/>
                  </div>
                </div>
              </div>
  ...
  <font color="#525252">
    <p align="center" style={{ margin: 0, textAlign: "center" }}>
      <font size={5}>
        <strong>
          <font color="#002060">◆강남역 가스통◆</font>
        </strong>
        <br />
      </font>
    </p>
      ...
      <span style={{ fontSize: "12pt" }}>
        <font color="#000000">
          <strong>
            이왕이면{" "}
            <font color="#ff0000">
              <font size={4}>꼼꼼</font>하고 <font size={4}>세심</font>한 저 김수철 실장과
            </font>
          </strong>
        </font>
      </span>
    ...
    <p align="center" style={{ margin: 0, textAlign: "center" }}>
      <span style={{ fontSize: "12pt" }}>
        <font color="#000000">
          <strong>
            저희 <font color="#ff0000">강남</font>
            <font color="#ff0000">가스통</font>은
          </strong>
        </font>
      </span>
    </p>
    ...
    <font color="#525252">
      <p align="center" style={{ margin: 0, textAlign: "center" }}>
        <span style={{ fontSize: "12pt" }}>
          ...
          <u>
            {" "}
            <strong>
              <font color="#c00000">◆강남</font>
              <font color="#ff0000">가스통</font>
      ...
      <p align="center" style={{ margin: 0, textAlign: "center" }}>
        <span style={{ color: "rgb(0, 117, 200)", fontSize: "11pt" }}>
          <strong>
            <u>
              <span style={{ color: "rgb(255, 0, 0)" }}>돈벌이1등 ◆강</span>
              <span style={{ color: "rgb(255, 0, 0)" }}>남</span>
              <font color="#ff0000">가스통</font>에 연락주세여
            </u>{" "}
            ^^*
          </strong>
        </span>
      ...
      <p align="center" style={{ margin: 0, textAlign: "center" }}>
        <span style={{ fontSize: "11pt" }}>
          <strong>
            <span style={{ color: "rgb(255, 0, 0)" }}>◆강남 가스통과 </span>
        ...
        <span style={{ fontSize: "11pt" }}>
          <font color="#000000">
            <strong>
              <img src />
              <font color="#c00000">◆강남</font>
              <font color="#ff0000">가스통</font>이 얼마든지 만들어 드려여 ^^*
            </strong>
          </font>
        </span>
      </p>
      ...
      <p align="center" style={{ margin: 0, textAlign: "center" }}>
        <span style={{ fontSize: "11pt" }}>
          <strong>
            ...
            <font color="#ff0000">남1등 ◆강남 가스통의&nbsp; 노하우로</font>
          </strong>
        </span>
      </p>
      <p align="center" style={{ margin: 0, textAlign: "center" }}>
      ...
      <p align="center" style={{ margin: 0, textAlign: "center" }}>
        <font style={{ fontSize: "12pt" }}>
          ...
          <font color="#0000ff">
            <span style={{ fontSize: "14pt" }}>
              <font color="#ff0000"> </font>:&nbsp;010-7523-7669{" "}
            </span>
          </font>
        </font>
      </p>
