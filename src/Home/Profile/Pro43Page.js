...
import pro43 from '../BoxLogo/43.jpg'
...
class Pro43Page extends Component {
  render() {
    return (
      <div>
        <Global />
            ...
            <div className="companyInfo infoBox">
              <div className="recruitInfo">
                <div className="company">
                  <span className="companyName">서초동 텐25</span>
                </div>
                <h1>★서초!역삼!강남!룸알바</h1>
                <div className="companyLogo">
                  <div className="logo">
                    <img src={pro43} alt="Smiley face"/>
                  </div>
                </div>
              </div>
  ...
  <font color="#525252">
    ...
    <blockquote
      style={{
        padding: "5px 10px",
        border: "1px solid rgb(211, 188, 235)",
        borderImage: "none",
    ...
    >
      ...
      <div style={{ textAlign: "center" }}>
        <b>
          <font size={5}>신규 오픈퍼블릭 텐25 에서</font>
        </b>
      </div>
      <div style={{ textAlign: "center" }}>
        <b>
          <font size={5}>언니들을 정중히 모십니다</font>
        </b>
      </div>
      <div style={{ textAlign: "center" }}>
        <b>
      ...
      <div style={{ textAlign: "center" }}>
        <b>
          <font size={3}>강남구 서초동(강남역부근)</font>
        </b>
      </div>
      <div style={{ textAlign: "center" }}>
        <br />
      ...
      <div style={{ textAlign: "center" }}>
        <b>
          <font size={3}>pm 7시출근 ~ 퇴근(언니들 지칠때까지)</font>
        </b>
      </div>
      <div style={{ textAlign: "center" }}>
        <b>
          <font size={3}>출퇴근자유</font>
        </b>
      </div>
      <div style={{ textAlign: "center" }}>
        <br />
    ...
    <blockquote
      style={{
        padding: "5px 10px",
        border: "1px solid rgb(232, 232, 139)",
        borderImage: "none",
        textAlign: "center",
    ...
    <blockquote
      style={{
        padding: "5px 10px",
        border: "1px solid rgb(195, 232, 158)",
        borderImage: "none",
        textAlign: "center",
        backgroundColor: "rgb(214, 255, 173)"
      }}
    >
      <b>
        <font size={3}>&nbsp;</font>
    ...
    <blockquote
      style={{
        padding: "5px 10px",
        border: "1px solid rgb(174, 232, 232)",
        borderImage: "none",
        backgroundColor: "rgb(191, 255, 255)"
      }}
    >
      <div style={{ textAlign: "center" }} />
      <div style={{ textAlign: "center" }}>
      ...
      <div style={{ textAlign: "center" }}>
        <b>
          <font size={3}>신경써서&nbsp;</font>
        </b>
        <b style={{ fontSize: "9pt" }}>
          <font size={3}>갯수마춰드립니다</font>
        </b>
      </div>
      <div style={{ textAlign: "center" }}>
        <b>
